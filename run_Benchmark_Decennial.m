...
%% Saving A and s for diagnostic tests, irfs and the counterfactual exp.s
...
% save('cf.mat','A','s','d2','P','y','X','rhho','pssi','gama','alfa')

%% Saving A and s for robustness analyses
% These runs should be executed one at a time.
% Lines 198 to 257 must be commented.

% Abm=A; sbm=s;
% save('bm.mat','Abm','sbm') % LivStd=alfa_t=gama_t=pssi_t=Tend_t=0
